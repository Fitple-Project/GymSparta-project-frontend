    ...
    <div v-if="showModal" class="modal-overlay">
      <div class="modal">
        ...
        <div class="modal-content">
          ...
          <p>
            <strong>☑️ 응모 기간:</strong> 8/19(월) ~ 8/28(금) 23:59까지
          </p>
          <p>
          ...
          <h4>🌐 주요 서비스 페이지 안내</h4>
          <ul>
            <li><strong>메인 페이지:</strong> <a href="https://www.gymspartatest.shop" target="_blank">https://www.gymspartatest.shop</a></li>
            <li><strong>로그인 페이지:</strong> <a href="https://www.gymspartatest.shop/login" target="_blank">https://www.gymspartatest.shop/login</a></li>
            <li><strong>회원가입 페이지:</strong> <a href="https://www.gymspartatest.shop/signup" target="_blank">https://www.gymspartatest.shop/signup</a></li>
            <li><strong>비즈니스 회원가입 페이지:</strong> <a href="https://www.gymspartatest.shop/business/signup" target="_blank">https://www.gymspartatest.shop/business/signup</a></li>
            <li><strong>운동 시설 검색 페이지:</strong> <a href="https://www.gymspartatest.shop/store/search" target="_blank">https://www.gymspartatest.shop/store/search</a></li>
            <li><strong>트레이너 비교 페이지:</strong> <a href="https://www.gymspartatest.shop/trainer/compare" target="_blank">https://www.gymspartatest.shop/trainer/compare</a></li>
            <li><strong>트레이너 상세 페이지:</strong> <a href="https://www.gymspartatest.shop/trainer/detail/:id" target="_blank">https://www.gymspartatest.shop/trainer/detail/:id</a></li>
            <li><strong>장바구니 페이지:</strong> <a href="https://www.gymspartatest.shop/cart" target="_blank">https://www.gymspartatest.shop/cart</a></li>
            <li><strong>결제 페이지:</strong> <a href="https://www.gymspartatest.shop/payments" target="_blank">https://www.gymspartatest.shop/payments</a></li>
            <li><strong>사용자 프로필 페이지:</strong> <a href="https://www.gymspartatest.shop/profile/user/:userId" target="_blank">https://www.gymspartatest.shop/profile/user/:userId</a></li>
            <li><strong>점주 프로필 페이지:</strong> <a href="https://www.gymspartatest.shop/profile/owner/:ownerId" target="_blank">https://www.gymspartatest.shop/profile/owner/:ownerId</a></li>
          </ul>
        </div>
