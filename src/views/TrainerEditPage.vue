<template>
  <div id="app" class="container">
    <div class="background">
      ...
      <div class="buttons">
        <button @click="editTrainer" class="edit-button">수정</button>
        <!-- 트레이너 수정 API 연결 예시 -->
        <!-- this.$axios.post('/api/trainer/edit', this.trainer) -->
        <button @click="deleteTrainer" class="delete-button">삭제</button>
        <!-- 트레이너 삭제 API 연결 예시 -->
        <!-- this.$axios.post('/api/trainer/delete', { trainerId: this.trainer.id }) -->
      </div>
    </div>
  </div>
</template>
